# CPU-Optimized Example - Topic Modeling for CPU Environments
#
# This example shows how to configure Meno for best performance on
# CPU-only environments without sacrificing quality.
"""
