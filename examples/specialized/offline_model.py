# Offline Model Usage - Working Without Internet Access
#
# This example shows how to use Meno in environments without internet access
# by using pre-downloaded local models.
"""
