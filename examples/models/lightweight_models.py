# Lightweight Models - CPU-Efficient Topic Modeling
#
# This example demonstrates using lightweight topic modeling approaches
# that work efficiently on CPU-only environments with minimal dependencies.
